...
private:
    ...
    // inline static QMap<Types::CharacterType,QMap<CharacterItem::CharacterPart, PartFramesCacheRegister>> ALL
    ...
    inline static std::unordered_map<CharacterItem::CharacterPart, QString> SKELETON_SPRITE_PATH_BASE
        = {
                  {CharacterItem::CharacterPart::Base, ":/characters/skeleton/base/"},
    };

    inline static std::map<Types::CharacterType,
        ...
        SPRITE_PATH_BASE = {
                  ...
                  {Types::CharacterType::Human, HUMAN_SPRITE_PATH_BASE},
                  {Types::CharacterType::GuardZombie, GOBLIN_SPRITE_PATH_BASE},
                  {Types::CharacterType::StationaryZombie, SKELETON_SPRITE_PATH_BASE},
                  {Types::CharacterType::Attacker, GOBLIN_SPRITE_PATH_BASE}
    ...
    static QImage GetFrameImageFromSprite(Types::CharacterType characterType,
    ...
    static QString GetFrameCacheKey(Types::CharacterType characterType,
                                    CharacterItem::CharacterPart whichPart,
                                    int whichGraphicsOption,
                                    int whichFrameId);
...
public:
    ...
    static QPixmap GetFrameFromSprite(Types::CharacterType characterType,
                                      CharacterItem::CharacterPart whichPart,
                                      int whichGraphicsOption,
                                      int whichFrameId);

    static std::vector<QPixmap> GetIdleFrameVariants(
        Types::CharacterType characterType,
